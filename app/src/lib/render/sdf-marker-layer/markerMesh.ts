...
// - CPU hit-testing (markerDistancePx) 鈥?replaces deck.gl GPU picking.
// - Interior meshes for the opaque depth pass (interiorMesh) 鈥?discard-free geometry
...
// Circle inscribes the unit quad (radius 1.0) 鈥?see sdf-marker-fragment.glsl.
...
/** Pin outline: tip, tangent edges, head arc 鈥?built in the SDF's internal frame
